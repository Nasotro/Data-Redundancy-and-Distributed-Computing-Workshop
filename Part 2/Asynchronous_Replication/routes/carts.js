...
router.post("/:userId", async (req, res) => {
  try {
    ...
    // Asynchronously replicate the cart to the secondary database
    const cartMirror = new CartMirror(cart);
    cartMirror.save().catch(err => console.error("Error saving cart mirror:", err));
...
router.delete("/:userId", async (req, res) => {
  try {
    ...
    // Asynchronously replicate the cart deletion to the secondary database
    CartMirror.findOneAndDelete({ userId: req.params.userId }).catch(err => console.error("Error deleting cart mirror:", err));
